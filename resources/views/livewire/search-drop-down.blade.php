<div>
    	<div class="relative mt-3 md:mt-0" x-data="{isOpen:true}" @click.away="{isOpen= false}">
						<input wire:model="search".debounce.500ms type="text"
                            x-ref="search"
                            @keydown.window="
                         ...
                         class="bg-gray-800 text-sm rounded-full w-64 pl-8 px-4 py-1 focus:outline-none focus:shadow-outline" placeholder="Search">
                            ...
                            <!-- displaying the search results from the array to the view -->
                             @foreach($searchResults as $result)
                                ...
                                <a href="{{route('movies.show', $result['id'])}}"
                                 ...
                                 class=" flex items-center block hover:border-gray-700 px-3 py-3 transition ease-in-out duration-150" 
