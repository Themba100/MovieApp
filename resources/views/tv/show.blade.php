...
@section('content')
	...
	<img src="{{$tvshow['poster_path'] }}" alt="movie" class="w-64 mt-1 md:w-96">
			<div class=" md:ml-24">
							...
							<div class="flex mt-4">
								<div class="mr-4">
										@foreach($tvshow['created_by'] as $crew)
												...
												<div class="ml-8">
													<div>{{$crew['name']}}</div>
													<text-sm class="text-gray-400">Creator</text-sm>
											    </div>
				...
				<div x-data="{isOpen: false}">
						<!-- Check if the tvshow has results -->
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
	...
	<!-- End of tvshow-details -->
<div class="tvshow-cast border-gray-800 border-b">
